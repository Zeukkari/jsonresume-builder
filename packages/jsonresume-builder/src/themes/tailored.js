...
import { deepMerge, deepFreeze, normalizeColor } from 'grommet/utils'
...
export var generate = function generate(baseSpacing, scale) {
  ...
  var result = deepMerge(iconBase, {
    global: {
      ...
      font: Object.assign({}, fontSizing(0)),
      hover: {
        background: {
          dark: {
            color: 'active',
    ...
    heading: {
      ...
      level: {
        1: {
          ...
          small: Object.assign({}, fontSizing(4)),
          medium: Object.assign({}, fontSizing(8)),
          large: Object.assign({}, fontSizing(16)),
          xlarge: Object.assign({}, fontSizing(24)),
        },
        2: {
          font: {
            // family: undefined,
          ...
          small: Object.assign({}, fontSizing(2)),
          medium: Object.assign({}, fontSizing(4)),
          large: Object.assign({}, fontSizing(8)),
          xlarge: Object.assign({}, fontSizing(12)),
        },
        3: {
          font: {
            // family: undefined,
          ...
          small: Object.assign({}, fontSizing(1)),
          medium: Object.assign({}, fontSizing(2)),
          large: Object.assign({}, fontSizing(4)),
          xlarge: Object.assign({}, fontSizing(6)),
        },
        4: {
          font: {
            // family: undefined,
          ...
          small: Object.assign({}, fontSizing(0)),
          medium: Object.assign({}, fontSizing(0)),
          large: Object.assign({}, fontSizing(0)),
          xlarge: Object.assign({}, fontSizing(0)),
        },
        5: {
          font: {
            // family: undefined,
          ...
          small: Object.assign({}, fontSizing(-0.5)),
          medium: Object.assign({}, fontSizing(-0.5)),
          large: Object.assign({}, fontSizing(-0.5)),
          xlarge: Object.assign({}, fontSizing(-0.5)),
        },
        6: {
          font: {
            // family: undefined,
          ...
          small: Object.assign({}, fontSizing(-1)),
          medium: Object.assign({}, fontSizing(-1)),
          large: Object.assign({}, fontSizing(-1)),
          xlarge: Object.assign({}, fontSizing(-1)),
        },
      },
      responsiveBreakpoint: 'small',
    ...
    paragraph: {
      ...
      medium: Object.assign({}, fontSizing(0)),
      large: Object.assign({}, fontSizing(1)),
      xlarge: Object.assign({}, fontSizing(2)),
      xxlarge: Object.assign({}, fontSizing(4)),
      color: 'red',
    },
    radioButton: {
      border: {
    ...
    text: {
      xsmall: Object.assign({}, fontSizing(-1.5)),
      small: Object.assign({}, fontSizing(-1)),
      medium: Object.assign({}, fontSizing(0)),
      large: Object.assign({}, fontSizing(1)),
      xlarge: Object.assign({}, fontSizing(2)),
