...
const SinglePage = ({ id }) => (
  <Page singleMode={true} id={id}>
    ...
    <div>
      You can add any valid html markup to this page, as long as it doesn't
      overflows
    </div>
    ...
    <div className="tc">
      ...
      <div className="serif black-50 tc f6 mt2">
        With credits styling | Image by Icons8 team on{' '}
        <a href="https://unsplash.com/photos/6LZuSzSwso0">Unsplash</a>
      </div>
    </div>
  </Page>
)
